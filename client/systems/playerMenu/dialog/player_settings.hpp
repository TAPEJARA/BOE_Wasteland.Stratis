...
class playerSettings {
	...
	class controls {
		...
		class btnDistanceNear : w_RscButton {
			idc = -1;
			text = "Perto";
			onButtonClick = "setViewDistance 1000; setObjectViewDistance 1000; setTerrainGrid 25;";
			x = 0.02; y = 0.37;
			w = 0.125; h = 0.033 * safezoneH;
		};
		...
		class btnDistanceMedium : w_RscButton {
			idc = -1;
			text = "Médio";
			onButtonClick = "setViewDistance 2000; setObjectViewDistance 2000; setTerrainGrid 6.25;";
			x = 0.02; y = 0.47;
			w = 0.125; h = 0.033 * safezoneH;
		};
		...
		class btnDistanceFar : w_RscButton {
			idc = -1;
			text = "Longe";
			onButtonClick = "setViewDistance 3000; setObjectViewDistance 3000; setTerrainGrid 3.125;";
			x = 0.02; y = 0.57;
			w = 0.125; h = 0.033 * safezoneH;
		};
