...
_serverInfoString = format ["<t color='#A0FFFFFF'>BOE - Wasteland Stratis</t>"];
...
_generalInfoString = "Fanpage: <t color='#0091CD'><a href='https://www.facebook.com/clanboe/'>facebook.com/clanBOE</a></t>     TeamSpeak: boe.ts3.com.br";
_generalInfoText ctrlSetStructuredText parseText _generalInfoString;


_rulesOnline = "https://www.facebook.com/clanboe/";
_rulesOffline = "addons\TOParmaInfo\rules.html";
_newsOnline = "https://www.facebook.com/clanboe/";
_newsOffline = "addons\TOParmaInfo\news.html";
_statsOnline = "http://www.gametracker.com/server_info/185.50.104.72:2302/" + _uid;
