//Client Menu Building for DoMPSA Assistance 
...
[
	["DoMPSA",true],
			...
			["Cancelar DoMPSA", [4], "", -3, [["expression", ""]], "1", "1"]
];
//////////////////////////////////////////////////////
...
_endVehMenu = ["Cancelar DoMPSA", [_i+2], "", -3, [["expression", ""]], "1", "1"];
...
_endSupMenu = ["Cancelar DoMPSA", [_i+2], "", -3, [["expression", ""]], "1", "1"];
