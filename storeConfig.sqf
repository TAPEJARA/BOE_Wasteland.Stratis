...
[
	// Handguns
	["P07 Pistol", "hgun_P07_F", 75],
	["Rook-40 Pistol", "hgun_Rook40_F", 100],
	["ACP-C2 Pistol", "hgun_ACPC2_F", 100],
	["Zubr Revolver", "hgun_Pistol_heavy_02_F", 125],
...
[
	...
	["MX Rifle", "arifle_MX_F", 375],
	["MX Rifle (Black)", "arifle_MX_Black_F", 375],
	["MX 3GL Rifle", "arifle_MX_GL_F", 400],
	...
	// DLC
	["Mk14 Rifle (Camo) [DLC]", "srifle_DMR_06_camo_F", 850],
	["Mk14 Rifle (Olive) [DLC]", "srifle_DMR_06_olive_F", 850],
	["Mk-I EMR Rifle (Black) [DLC]", "srifle_DMR_03_F", 900],
	["Mk-I EMR Rifle (Camo) [DLC]", "srifle_DMR_03_multicam_F", 900],
	["Mk-I EMR Rifle (Khaki) [DLC]", "srifle_DMR_03_khaki_F", 900],
	["Mk-I EMR Rifle (Sand) [DLC]", "srifle_DMR_03_tan_F", 900],
	["Mk-I EMR Rifle (Woodland) [DLC]", "srifle_DMR_03_woodland_F", 900],
	//["NATO DMR (provisional) spotter [DLC]", "srifle_DMR_03_spotter_F", 1500], // BUGGED
	["MAR-10 Rifle (Black) [DLC]", "srifle_DMR_02_F", 1100],
	["MAR-10 Rifle (Camo) [DLC]", "srifle_DMR_02_camo_F", 1100],
	["MAR-10 Rifle (Sand) [DLC]", "srifle_DMR_02_sniper_F", 1100],
	["Cyrus Rifle (Black) [DLC]", "srifle_DMR_05_blk_F", 1600],
	["Cyrus Rifle (Hex) [DLC]", "srifle_DMR_05_hex_F", 1600],
	["Cyrus Rifle (Tan) [DLC]", "srifle_DMR_05_tan_f", 1600],

	// Sniper Rifles
	["Rahim 7.62 mm", "srifle_DMR_01_F", 600],
	["M320 LRR Sniper", "srifle_LRR_LRPS_F", 3000],
	["M320 LRR Sniper (Camo)", "srifle_LRR_camo_LRPS_F", 3300],
	["GM6 Lynx Sniper", "srifle_GM6_LRPS_F", 3700],
	["GM6 Lynx Sniper (Camo)", "srifle_GM6_camo_LRPS_F", 3900],

	["ASP-1 Kir Rifle (Black) [DLC]", "srifle_DMR_04_F", 2000],
...
[
	...
	["Navid MMG (Tan) [DLC]", "MMG_01_tan_F", 1050],
	["Navid MMG (Hex) [DLC]", "MMG_01_hex_F", 1050],
	["SPMG MMG (Sand) [DLC]", "MMG_02_sand_F", 1150],
	["SPMG MMG (MTP) [DLC]", "MMG_02_camo_F", 1150],
	["SPMG MMG (Black) [DLC]", "MMG_02_black_F", 1150]
];
...
[
	...
	["Titan MPRL AA (Desert)", "launch_Titan_F", 2500],
...
[
	...
	//["Mk6 Mortar (NATO)", "B_Mortar_01_F", 300000],
	//["Mk6 Mortar (CSAT)", "O_Mortar_01_F", 300000],
	//["Mk6 Mortar (AAF)", "I_Mortar_01_F", 300000]
];
...
[
	...
	["Explosivo Direcional Remoto", "ClaymoreDirectionalMine_Remote_Mag", 350],
	...
	["Small IED (Urban) - Allahu Akbar", "IEDUrbanSmall_Remote_Mag", 1500],
	["Small IED (Dug-in) - Allahu Akbar", "IEDLandSmall_Remote_Mag", 1500],
	["Large IED (Urban) - Allahu Akbar", "IEDUrbanBig_Remote_Mag", 2000],
	["Large IED (Dug-in) - Allahu Akbar", "IEDLandBig_Remote_Mag", 2000]
];
...
[
	...
	["12.7mm 5Rnd Armor-Piercing Mag", "5Rnd_127x108_APDS_Mag", 350],
...
[
	["Suppressor 9mm", "muzzle_snds_L", 300, "item"],
	["Suppressor .45 ACP", "muzzle_snds_acp", 375, "item"],
	["Suppressor 5.56mm", "muzzle_snds_M", 400, "item"],
	["Suppressor 6.5mm", "muzzle_snds_H", 450, "item"],
	["Suppressor 6.5mm LMG", "muzzle_snds_H_MG", 500, "item"],
	["Suppressor 7.62mm", "muzzle_snds_B", 650, "item"],
	["Suppressor .338 [DLC]", "muzzle_snds_338_black", 850, "item"],
	["Suppressor .338 (Green) [DLC]", "muzzle_snds_338_green", 850, "item"],
	["Suppressor .338 (Sand) [DLC]", "muzzle_snds_338_sand", 850, "item"],
	["Suppressor 9.3mm [DLC]", "muzzle_snds_93mmg", 950, "item"],
	["Suppressor 9.3mm (Tan) [DLC]", "muzzle_snds_93mmg_tan", 950, "item"],
	...
	["AMS [DLC]", "optic_AMS", 950, "item"],
	["AMS (Khaki) [DLC]", "optic_AMS_khk", 950, "item"],
	["AMS (Sand) [DLC]", "optic_AMS_snd", 950, "item"],
	["Kahlia [DLC]", "optic_KHS_blk", 800, "item"],
	["Kahlia (Hex) [DLC]", "optic_KHS_hex", 800, "item"],
	["Kahlia (Tan) [DLC]", "optic_KHS_tan", 800, "item"],
	["Kahlia (Old) [DLC]", "optic_KHS_old", 800, "item"],
	["LRPS", "optic_LRPS", 1200, "item"],
	["NVS", "optic_NVS", 2000, "item"],
	["TWS", "optic_tws", 17500, "item"],
	["TWS MG", "optic_tws_mg", 18500, "item"],
	["Nightstalker", "optic_Nightstalker", 25000, "item"]
];

// If commented, means the color/camo isn't implemented or is a duplicate of another hat
headArray = compileFinal str
[
	["Gas Mask (NATO)", "H_CrewHelmetHeli_B", 1200, "hat"],
	["Gas Mask (CSAT)", "H_CrewHelmetHeli_O", 1200, "hat"],
	["Gas Mask (AAF)", "H_CrewHelmetHeli_I", 1200, "hat"],
	["ECH", "H_HelmetB", 75, "hat"],
	["ECH (Ghillie)", "H_HelmetB_camo", 75, "hat"],
	["ECH (Light)", "H_HelmetB_light", 75, "hat"],
	["ECH (Spraypaint)", "H_HelmetB_paint", 75, "hat"],
	...
	["Heli Pilot Helmet (NATO)", "H_PilotHelmetHeli_B", 75, "hat"],
	["Heli Pilot Helmet (CSAT)", "H_PilotHelmetHeli_O", 75, "hat"],
	["Heli Pilot Helmet (AAF)", "H_PilotHelmetHeli_I", 75, "hat"],
	["Crew Helmet (NATO)", "H_HelmetCrew_B", 50, "hat"],
	["Crew Helmet (CSAT)", "H_HelmetCrew_O", 50, "hat"],
	["Crew Helmet (AAF)", "H_HelmetCrew_I", 50, "hat"],
	["Pilot Helmet (NATO)", "H_PilotHelmetFighter_B", 75, "hat"],
	["Pilot Helmet (CSAT)", "H_PilotHelmetFighter_O", 75, "hat"],
	["Pilot Helmet (AAF)", "H_PilotHelmetFighter_I", 75, "hat"],
...
[
	...
	["Carrier GL Rig (Green)", "V_PlateCarrierGL_rgr", 800, "vest"],
	["Carrier GL Rig (Black)", "V_PlateCarrierGL_blk", 800, "vest"],
	["Carrier GL Rig (MTP)", "V_PlateCarrierGL_mtp", 800, "vest"],
	["Carrier Special Rig (Green)", "V_PlateCarrierSpec_rgr", 900, "vest"],
	["Carrier Special Rig (Black)", "V_PlateCarrierSpec_blk", 900, "vest"],
	["Carrier Special Rig (MTP)", "V_PlateCarrierSpec_mtp", 900, "vest"],
	["GA Carrier Lite (Digi)", "V_PlateCarrierIA1_dgtl", 750, "vest"],
	["GA Carrier Rig (Digi)", "V_PlateCarrierIA2_dgtl", 750, "vest"],
	["GA Carrier GL Rig (Digi)", "V_PlateCarrierIAGL_dgtl", 750, "vest"],
	["GA Carrier GL Rig (Olive)", "V_PlateCarrierIAGL_oli", 750, "vest"],
...
[
	...
	["Quadrotor UAV (NATO)", "B_UAV_01_backpack_F", 15000, "backpack"],
	["Quadrotor UAV (CSAT)", "O_UAV_01_backpack_F", 15000, "backpack"],
	["Quadrotor UAV (AAF)", "I_UAV_01_backpack_F", 15000, "backpack"],
	["Remote Designator Bag (NATO)", "B_Static_Designator_01_weapon_F", 7500, "backpack"],
	["Remote Designator Bag (CSAT)", "O_Static_Designator_02_weapon_F", 7500, "backpack"],
	["GPS", "ItemGPS", 500, "gps"],
	["First Aid Kit", "FirstAidKit", 100, "item"],
	["Medikit", "Medikit", 500, "item"],
	["Toolkit", "ToolKit", 500, "item"],
	["Mine Detector", "MineDetector", 250, "item"],
	["NV Goggles Brown", "NVGoggles", 300, "nvg"],
	["NV Goggles Black", "NVGoggles_OPFOR", 300, "nvg"],
	["NV Goggles Green", "NVGoggles_INDEP", 300, "nvg"],
	["Binoculars", "Binocular", 500, "binoc"],
	["Rangefinder", "Rangefinder", 1000, "binoc"],
	["Laser Designator (NATO)", "Laserdesignator", 6500, "binoc"],
	["Laser Designator (CSAT)", "Laserdesignator_02", 8500, "binoc"],
	["Laser Designator (AAF)", "Laserdesignator_03", 7500, "binoc"],
	["IR Grenade (NATO)", "B_IR_Grenade", 150, "mag"],
	["IR Grenade (CSAT)", "O_IR_Grenade", 150, "mag"],
	["IR Grenade (AAF)", "I_IR_Grenade", 150, "mag"],
	["Chemlight (Blue)", "Chemlight_blue", 25, "mag"],
	["Chemlight (Green)", "Chemlight_green", 25, "mag"],
	["Chemlight (Yellow)", "Chemlight_yellow", 25, "mag"],
	["Chemlight (Red)", "Chemlight_red", 25, "mag"],
	["Aviator Glasses", "G_Aviator", 25, "gogg"],
	["Diving Goggles", "G_Diving", 300, "gogg"],
...
[
	["Container (P) - NÃO SALVA ITENS", "Land_CargoBox_V1_F", 50000, "object"],
	["Container (M) - NÃO SALVA ITENS", "Land_Cargo20_yellow_F", 75000, "object"],
	["Container (G) - NÃO SALVA ITENS", "Land_Cargo40_white_F", 100000, "object"],
//	["Base door (beta)", "Land_Canal_Wall_Stairs_F", 25000, "object"],  // LouD
//	["Base door key (PIN: 0000) (beta)", "Land_InfoStand_V2_F", 10000, "object"],  // LouD
	["Central da base (SENHA: 0000)", "Land_Device_assembled_F", 50000, "object"],  //Cael817, SNAFU,Used for base operations <-- Destroyable
	["COFRE (SENHA: 0000)", "Box_NATO_AmmoVeh_F", 70000, "ammocrate"],
	["Caixa de munição vazia", "Box_NATO_Ammo_F", 200, "ammocrate"],
	["ATM móvel", "Land_Atm_01_F", 4000000, "object"],
	["Cúpula", "Land_Dome_Small_F", 60000, "object"],
	["Cúpula grande", "Land_Dome_Big_F", 100000, "object"],
	["Fogueira", "Land_FirePlace_F", 100, "object"],
	["Plataforma pequena", "Land_GH_Platform_F", 500, "object"],
	["Poste (Halogéneo)", "Land_LampHalogen_F", 500, "object"],
	["Poste (Porto)", "Land_LampHarbour_F", 200, "object"],
	["Poste (Velho)", "Land_LampShabby_F", 200, "object"],
	["Poste (Chique) ", "Land_LampDecor_F", 400, "object"],
	["Poste (Rua) ", "Land_LampStreet_F", 400, "object"],
	["Poste (Aeroporto) ", "Land_LampAirport_F", 800, "object"],
	["Caixa de abastecimento", "Box_NATO_Support_F", 800, "object"],
	["Cancela", "Land_BarGate_F", 300, "object"],
	["Canos", "Land_Pipes_Large_F", 400, "object"],
	["Concreto armado", "Land_CncShelter_F", 400, "object"],
	["Guardirreio", "Land_Crash_barrier_F", 400, "object"],
	["Obstáculo de concreto (P)", "Land_CncBarrier_F", 400, "object"],
	["Obstáculo de concreto (M)", "Land_CncBarrierMedium_F", 700, "object"],
	["Obstáculo de concreto (G)", "Land_CncBarrierMedium4_F", 1000, "object"],
	["Barreira (1 bloco)", "Land_HBarrier_1_F", 300, "object"],
	["Barreira (3 blocos)", "Land_HBarrier_3_F", 400, "object"],
	["Barreira (5 blocos)", "Land_HBarrier_5_F", 500, "object"],
	["Barreira grande", "Land_HBarrierBig_F", 1000, "object"],
	["Barreira muralha (4 blocos)", "Land_HBarrierWall4_F", 800, "object"],
	["Barreira muralha (6 blocos)", "Land_HBarrierWall6_F", 1000, "object"],
	["Barreira guarita", "Land_HBarrierTower_F", 1200, "object"],
	["Muro de concreto", "Land_CncWall1_F", 800, "object"],
	["Obstáculo militar", "Land_Mil_ConcreteWall_F", 800, "object"],
	["Muro de concreto (L)", "Land_CncWall4_F", 1200, "object"],
	["Muro de concreto (G)", "Land_Mil_WallBig_4m_F", 1200, "object"],
	//["Shoot House Wall", "Land_Shoot_House_Wall_F", 180, "object"],
	["Paredão", "Land_Canal_WallSmall_10m_F", 800, "object"],
	["Paredão com edscada", "Land_Canal_Wall_Stairs_F", 1000, "object"],
	["Sacos de areia (canto)", "Land_BagFence_Corner_F", 300, "object"],
	["Sacos de areia (fim)", "Land_BagFence_End_F", 300, "object"],
	["Sacos de areia (longo)", "Land_BagFence_Long_F", 400, "object"],
	["Sacos de areia (curva)", "Land_BagFence_Round_F", 300, "object"],
	["Sacos de areia (curto)", "Land_BagFence_Short_F", 300, "object"],
	["Bunker (P)", "Land_BagBunker_Small_F", 300, "object"],
	["Bunker (G)", "Land_BagBunker_Large_F", 1000, "object"],
	["Bunker torre", "Land_BagBunker_Tower_F", 2000, "object"],
	["Posto militar", "Land_Cargo_Patrol_V1_F", 5000, "object"],
	["Torre militar", "Land_Cargo_Tower_V1_F", 7500, "object"],
	["QG militar", "Land_Cargo_HQ_V1_F", 10000, "object"], // Added on player request
	["Rampa de concreto", "Land_RampConcrete_F", 1000, "object"],
	["Rampa de concreto (G)", "Land_RampConcreteHigh_F", 1500, "object"],
	["Bloco de concreto", "BlockConcrete_F", 5000, "object"],
	["Andaimes", "Land_Scaffolding_F", 1000, "object"],
	["Cais", "Land_Pier_F", 250000, "object"],	
//	["Ghost Hotel Stairs", "Land_GH_Stairs_F", 500, "object"],
//	["Military Cargo HQ (Brown)", "Land_Cargo_HQ_V3_F", 5000, "object"],
	["Rampa", "Land_Obstacle_Ramp_F", 100, "object"],	
	...
	["Box container [DLC]", "B_Slingload_01_Cargo_F", 8000, "object"],
	["Fuel container [DLC]", "B_Slingload_01_Fuel_F", 8500, "object"],
	["Medical container [DLC]", "B_Slingload_01_Medevac_F", 12500, "object"],
	["Repair container [DLC]", "B_Slingload_01_Repair_F", 10000, "object"],
	["Ammo container [DLC]", "B_Slingload_01_Ammo_F", 50000, "object"],
	["Box pod from Mi-290 Taru  [DLC]", "Land_Pod_Heli_Transport_04_box_F", 800000, "object"],
	["Fuel pod from Mi-290 Taru  [DLC]", "Land_Pod_Heli_Transport_04_fuel_F", 8500, "object"],
	["Bench pod from Mi-290 Taru  [DLC]", "Land_Pod_Heli_Transport_04_bench_F", 9000, "object"],
	["Transport pod from Mi-290 Taru  [DLC]", "Land_Pod_Heli_Transport_04_transport_F", 9500, "object"],
	//["Medical pod from Mi-290 Taru  [DLC]", "Land_Pod_Heli_Transport_04_medical_F",12500, "object"],
	["Repair pod from Mi-290 Taru  [DLC]", "Land_Pod_Heli_Transport_04_repair_F", 10000, "object"],
	["Ammo pod from Mi-290 Taru [DLC]", "Land_Pod_Heli_Transport_04_ammo_F", 50000, "object"]
];
...
[
	...
	["MBT-52 Kuma", "I_MBT_03_cannon_F", 85000, "vehicle"]
	//["M5 Sandstorm MLRS", "B_MBT_01_mlrs_F", 750000, "vehicle"],
...
[
	...
	["PO-30 Orca (Armed, Hex)", "O_Heli_Light_02_F", 125000, "vehicle"], // Armed Ka-60
	["Mi-48 Kajman (Hex)", "O_Heli_Attack_02_F", 300000, "vehicle"], // Mi-28 with gunner
	["Mi-48 Kajman (Black)", "O_Heli_Attack_02_black_F", 300000, "vehicle"], // Mi-28 with gunner (black camo)
	["AH-99 Blackfoot", "B_Heli_Attack_01_F", 350000, "vehicle"] // RAH-66 with gunner

];

planesArray = compileFinal str
[
	["A-143 Buzzard AA", "I_Plane_Fighter_03_AA_F", 225000, "vehicle"],
	["A-143 Buzzard CAS", "I_Plane_Fighter_03_CAS_F", 250000, "vehicle"],
	["To-199 Neophron CAS", "O_Plane_CAS_02_F", 275000, "vehicle"],
	["A-164 Wipeout CAS", "B_Plane_CAS_01_F", 350000, "vehicle"],
...
[
	...
	[ // MH-9 colors
		...
		[
			["SAMU (MH-9)", [[0, _texDir + "LittleBirdSAMU.paa"]]],
	...
	[ // Hellcat colors
		...
		[
			["POLICIA", [[0, _texDir + "hellcat_cop.paa"]]]
		]
	],
	[ // Hellcat colors
		"I_Heli_light_03_F",
...
[
	...
	["Vehicle Pinlock", "pinlock", localize "STR_WL_ShopDescriptions_Pinlock", "client\icons\keypad.paa", 3000, 500],
	...
	["Spawn Beacon", "spawnbeacon", localize "STR_WL_ShopDescriptions_spawnBeacon", "client\icons\spawnbeacon.paa", 2500, 1000],
