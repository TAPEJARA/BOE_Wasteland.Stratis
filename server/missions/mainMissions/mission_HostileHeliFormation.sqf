...
private ["_heliChoices", "_convoyVeh", "_veh1", "_veh2", "_veh3", "_createVehicle", "_vehicles", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_vehicleName2", "_numWaypoints","_cash","_box1", "_box2", "_box3"];
...
_setupObjects =
{
	...
	_missionHintText = format ["Uma formação de helicópteros armados contendo um <t color='%3'>%1</t> e dois <t color='%3'>%2</t> estão patrulhando a ilha. Destrua-os e pegue a sua carga!", _vehicleName, _vehicleName2, mainMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "O céu está limpo novamente, a patrulha inimiga foi abatida! caixas de equipamentos caíram perto da queda.";
};
