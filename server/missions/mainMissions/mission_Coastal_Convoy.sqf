...
_setupObjects =
{
	...
	_missionHintText = format ["Dois <t color='%3'>%1</t> estão patrulhando a costa, escoltado por um <t color='%3'>%2</t>.<br/>Intercepte-os e pegue sua carga!", _vehicleName, _vehicleName2, mainMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "A patrulha detida, as caixas de equipamento estão perto dos destroços!";
};
