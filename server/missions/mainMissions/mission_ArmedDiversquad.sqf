...
_setupVars =
{
	_missionType = "Expedição de Mergulho";
...
_setupObjects =
{
	...
	_missionHintText = "Uma expedição armada está tentando recuperar caixas de munição afundados.<br/>Se você quer capturá-los, você vai precisar de equipamento de mergulho e uma arma apropriada.";
};
...
_successExec =
{
	...
	_successHintMessage = "As caixas afundados foram capturados, bom trabalho.";
};
