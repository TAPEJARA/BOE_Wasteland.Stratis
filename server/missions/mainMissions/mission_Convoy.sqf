...
_setupObjects =
{
	...
	_missionHintText = format ["Um <t color='%2'>%1</t> transportando 2 caixas de armas sendo escoltado por veículos armados. Pegue-os!", _vehicleName, mainMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "O comboio foi neutralizado, as caixas de armas e veículos estão livre para pega-los.";
};
