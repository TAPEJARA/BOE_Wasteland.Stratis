...
_setupObjects =
{
	...
	_missionHintText = format ["Uma formação de jatos, contendo dois <t color='%3'>%1</t> estão patrulhando a ilha. Destrua-os para pegar sua carga!", _vehicleName, _vehicleName2, mainMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "O céu está limpo novamente, os jatos foram abatidos! caixas de equipamentos e algum dinheiro caíram junto com o piloto.";
};
