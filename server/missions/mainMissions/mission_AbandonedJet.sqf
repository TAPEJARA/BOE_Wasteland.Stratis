...
_setupObjects =
{
	...
	_missionHintText = format ["Um <t color='%3'>%2</t> foi imobilizado, pegue-o para sua equipe!", _vehDeterminer, _vehicleName, mainMissionColor];	
};
