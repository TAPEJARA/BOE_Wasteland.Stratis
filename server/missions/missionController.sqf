...
diag_log format ["BOE WASTELAND - Iniciando Controlador da Missão: %1%2", MISSION_CTRL_TYPE_NAME, _controllerSuffix];
...
while {true} do
{
	...
	diag_log format ["BOE WASTELAND - Missão %1 %2 esperando para ser executada: %3", MISSION_CTRL_TYPE_NAME, _controllerSuffix, _nextMission];
	...
	[
		...
		[
			...
			"<t color='%1'>---------------------------------------------</t><br/>" +
			"<t color='%4' size='1.0'>Vai começar em %5 minutos</t>",
