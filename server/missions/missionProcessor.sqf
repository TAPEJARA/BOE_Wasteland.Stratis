...
diag_log format ["BOE WASTELAND - Missão: %1 %2 começou: %3", MISSION_PROC_TYPE_NAME, _controllerSuffix, _missionType];
...
diag_log format ["BOE WASTELAND - Missão: %1 %2 esperando para ser concluída: %3", MISSION_PROC_TYPE_NAME, _controllerSuffix, _missionType];
...
if (_failed) then
{
	...
	diag_log format ["BOE WASTELAND - Missão: %1 %2 fracassou: %3", MISSION_PROC_TYPE_NAME, _controllerSuffix, _missionType];
}
else
{
	// Mission completed
	...
	diag_log format ["BOE WASTELAND - %1 %2 completada: %3", MISSION_PROC_TYPE_NAME, _controllerSuffix, _missionType];
};
