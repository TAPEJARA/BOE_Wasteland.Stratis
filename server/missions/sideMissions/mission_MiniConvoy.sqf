...
_setupVars =
{
	_missionType = "Comboio de Caminhões";
...
_setupObjects =
{
	...
	_missionHintText = format ["Um <t color='%2'>%1</t> transportando 2 caixas de armas está sendo escoltado. Intercepte esse comboio!", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "O comboio foi interceptado, as caixas de armas e veículos estão livres agora, pode toma-los.";
};
