...
_setupVars =
{
	_missionType = "Contrabandistas de Armas";
...
_setupObjects =
{
	...
	_missionHintText = format ["Um grupo de contrabandistas de armas foram vistos. Acabe com esse negócio e pegue as armas e dinheiro pra você.", sideMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Os contrabandistas estão mortos, armas, drogas e dinheiro estão no chão!"];
};
