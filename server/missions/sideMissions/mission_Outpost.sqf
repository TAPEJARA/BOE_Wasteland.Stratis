...
_setupObjects =
{
	...
	_missionHintText = format ["Um <t color='%1'>posto avançado inimigo</t> contendo caixas de armas foi descoberto perto do marcador, vão capturá-lo!", sideMissionColor]
};
