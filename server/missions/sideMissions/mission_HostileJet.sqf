...
_setupObjects =
{
	...
	_missionHintText = format ["Um <t color='%2'>%1</t> armado esta patrulahndo a ilha. Intercepte e recupere sua carga!", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Céu limpo, patrulha inimiga foi abatida! Caixas de equipamentos e algum dinheiro caíram junto ao piloto.";
};
