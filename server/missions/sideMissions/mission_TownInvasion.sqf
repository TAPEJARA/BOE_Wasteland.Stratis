...
_setupVars =
{
	_missionType = "Invasão de Cidade";
...
_setupObjects =
{
	...
	_missionHintText = format ["Hostis assumiram <br/><t size='1.25' color='%1'>%2</t><br/><br/>Parece haver <t color='%1'>%3 enimigos</t> escondidos no interior ou no topo de edifícios. Livre-se deles, e pegue seus suprimentos!<br/>Cuidado com as janelas!", sideMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Bom trabalho!<br/><br/><t color='%1'>%2</t><br/>está segura novamente!<br/>Pegue o que quiser", sideMissionColor, _townName];
