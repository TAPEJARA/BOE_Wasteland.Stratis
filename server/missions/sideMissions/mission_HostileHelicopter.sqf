...
private ["_vehicleClass", "_vehicle", "_createVehicle", "_vehicles", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_numWaypoints","_cash", "_box1", "_box2"];
...
_setupObjects =
{
	...
	_missionHintText = format ["Um <t color='%2'>%1</t> armado esta patrulahndo a ilha. Intercepte e recupere a sua carga!", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	for "_i" from 1 to 5 do
	{
		...
		_cash setPos ([_lastPos, [[2 + random 3,2,1], random 360] call BIS_fnc_rotateVector2D] call BIS_fnc_vectorAdd);
	...
	_successHintMessage = "Céu limpo, patrulha inimiga foi abatida! caixas caíram perto ponto da queda.";
};
