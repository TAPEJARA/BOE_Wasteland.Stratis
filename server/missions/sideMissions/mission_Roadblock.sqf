...
_setupObjects =
{
	...
	_missionHintText = format ["Inimigos criaram uma bloqueio ilegal e estão parando todos os veículos! Eles precisam ser eliminados!", sideMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["O bloqueio foi desmantelado."];
};
