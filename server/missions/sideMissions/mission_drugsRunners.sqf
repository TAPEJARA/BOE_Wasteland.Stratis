...
_setupVars =
{
	_missionType = "Traficante de Drogas";
	_locationsArray = nil;
};
...
_setupObjects =
{
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			case (_type isKindOf "I_G_Offroad_01_armed_F"):
			{
	...
	_missionHintText = format ["Traficante dirigindo um  <t color='%2'>%1</t> estão transpotando drogas pela ilha. Mate-os e fique com as drogas.", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Os traficantes foram mortos! Use :) ou venda as drogas!";
};
