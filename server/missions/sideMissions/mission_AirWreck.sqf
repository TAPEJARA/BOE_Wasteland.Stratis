...
_setupVars =
{
	_missionType = "Queda de Aeronave";
...
_setupObjects =
{
	...
	_missionHintText = "Um helicóptero caiu sob fogo inimigo!";
};
...
_successExec =
{
	...
	_successHintMessage = "Os suprimentos da aeronave foram recolhidos, bom trabalho.";
};
