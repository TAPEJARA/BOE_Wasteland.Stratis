...
_setupVars =
{
	...
	[
		// Easy
		[
			"Pequena Remessa de Dinheiro", // Marker text
			150000, // Money
			[
				[ // NATO convoy
		...
		// Medium
		[
			"Remessa de Dinheiro", // Marker text
			250000, // Money
			[
				[ // NATO convoy
					["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"], // Veh 1
		...
		// Hard
		[
			"Grande Remessa de Dinheiro", // Marker text
			350000, // Money
			[
				[ // NATO convoy
		...
		// Extreme
		[
			"Carregamento de Dinheiro", // Marker text
			450000, // Money
			[
				[ // NATO convoy
...
_setupObjects =
{
	...
	_missionHintText = format ["Um comboio transportando <t color='%1'>%2</t> escoltado por um <t color='%1'>%3</t> está a caminho de um local desconhecido.<br/> PEGUE-OS!", moneyMissionColor, _moneyText, _vehicleName];
...
_successExec =
{
	...
	_successHintMessage = "O comboio foi destruido, pegue a grana!";
};
