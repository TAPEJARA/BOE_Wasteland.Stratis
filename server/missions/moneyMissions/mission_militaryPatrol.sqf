...
_setupObjects =
{
	...
	_missionHintText = format ["Um comboio contendo, pelo menos, um <t color='%4'>%1</t>, um <t color='%4'>%2</t> e um <t color='%4'>%3</t> estão patrulhando uma localização estratégica! Detenha a patrulha e pegue os equipamentos e dinheiro!", _vehicleName, _vehicleName2, _vehicleName3, moneyMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "A patrulha foi neutralizada, o dinheiro, caixas e veículos já podem ser tomados.";
};
