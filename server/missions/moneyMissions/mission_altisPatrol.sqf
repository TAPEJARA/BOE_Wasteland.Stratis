...
_setupVars =
{
	_missionType = "Patrulha Motorizada";
	_locationsArray = nil;
};
...
_setupObjects =
{
	...
	_missionHintText = format ["Um comboio contendo, pelo menos, um <t color='%4'>%1</t>, um <t color='%4'>%2</t> e um <t color='%4'>%3</t> está patrulhando Stratis! Embosque a patrulha para conseguir equipamentos e dinheiro!", _vehicleName, _vehicleName2, _vehicleName3, moneyMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "A patrulha foi parada, dinheiro, drogas, caixas e veículos são seus para tomar.";
};
